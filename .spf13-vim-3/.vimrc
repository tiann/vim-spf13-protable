...
" Vim UI {
    ...
    if filereadable(expand("$VIM/.vim/bundle/vim-colors-solarized/colors/solarized.vim"))
...
" Plugins {
    ...
    " PIV {
        if isdirectory(expand("$VIM/.vim/bundle/PIV"))
    ...
    " Misc {
        if isdirectory(expand("$VIM/.vim/bundle/nerdtree"))
            let g:NERDShutUp=1
        endif
        if isdirectory(expand("$VIM/.vim/bundle/matchit.zip"))
    ...
    " Tabularize {
        if isdirectory(expand("$VIM/.vim/bundle/tabular"))
    ...
    " Session List {
        ...
        if isdirectory(expand("$VIM/.vim/bundle/sessionman.vim/"))
    ...
    " PyMode {
        ...
        if isdirectory(expand("$VIM/.vim/bundle/python-mode"))
    ...
    " ctrlp {
        if isdirectory(expand("$VIM/.vim/bundle/ctrlp.vim/"))
    ...
    " TagBar {
        if isdirectory(expand("$VIM/.vim/bundle/tagbar/"))
    ...
    " Fugitive {
        if isdirectory(expand("$VIM/.vim/bundle/vim-fugitive/"))
    ...
    " UndoTree {
        if isdirectory(expand("$VIM/.vim/bundle/undotree/"))
    ...
    " indent_guides {
        if isdirectory(expand("$VIM/.vim/bundle/vim-indent-guides/"))
    ...
    " vim-airline {
        ...
        if isdirectory(expand("$VIM/.vim/bundle/vim-airline/"))
...
" Functions {
    ...
    function! InitializeDirectories()
        ...
        "   eg: let g:spf13_consolidated_directory = $VIM . '/.vim/'
